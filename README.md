# ⚡ Pedro Matías Soria — Software a Medida & Soluciones Digitales

> Portafolio profesional personal. Desarrollo de aplicaciones web distribuidas, computer vision en el cliente, Progressive Web Apps (PWA) 100% offline-first y automatizaciones eficientes de bajo costo.
...
JavaScript ES6+ (Vanilla), WebRTC (PeerJS), HTML5 Canvas, PWA (Service Workers), Python (FastAPI/Scraping), Flutter 3, Firebase, Cloudflare Quick Tunnels, Leaflet.js, OpenStreetMap, Tailwind CSS.

---

## 📬 Contacto
- **Portafolio:** [soriam.vercel.app](https://soriam.vercel.app)
