...
// Logo geométrico: tres triángulos interconectados.
export function Logo({ className = '' }) {
  return (
    <svg viewBox="0 0 48 48" className={className} fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" aria-hidden="true">
      <path d="M5 21 L43 5 L27 43 Z" />
      <path d="M5 21 L22 26 L43 5" />
      <path d="M22 26 L27 43" />
